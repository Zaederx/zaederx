...
[Patient Health App](https://github.com/Zaederx/PatientHealthRewrite) & [demo site link](https://patient-health-app.herokuapp.com/)- Spring Boot MVC + Spring Security, Thymeleaf, HTML, CSS, JavaScript, Gradle, MySQL(then changed to H2)
